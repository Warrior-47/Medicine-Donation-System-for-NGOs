"""
Django settings for the medicine-service.

Owns NGO and donor medicine lists (including uploaded expiry-date images)
and serves the dashboard. Authentication comes from the signed-cookie
session issued by user-service; this service has no users table.
"""
...
# Uploaded expiry-date images live under static/img so the dev static server
# can serve them; in Kubernetes this directory is backed by the PVC mounted
# at /app/static/img/medicine_images.
